    ...
    <aside class="sidebar">
        <div class="sidebar-brand">
            <div class="brand-icon">
                <img src="{{ asset('images/logo.png') }}" alt="Dot.Dopemine" style="width:100%;height:100%;object-fit:contain;border-radius:10px;">
            </div>
            <div>
                <div class="brand-name">Dot.Dopemine</div>
                <div class="brand-status">
                    <div class="live-dot"></div>
                    <span class="brand-subtitle">Engagement Intelligence</span>
                </div>
            </div>
        </div>
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('mechanics.index') }}" class="nav-item {{ request()->routeIs('mechanics.*') ? 'active' : '' }}">
                <span class="material-symbols-rounded nav-icon">auto_awesome</span>
                Mechanic Catalog
            </a>
            <a href="{{ route('mechanics.deployments') }}" class="nav-item {{ request()->routeIs('mechanics.deployments') ? 'active' : '' }}">
